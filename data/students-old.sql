...
INSERT INTO school_table
	...
	(null,'Business'),
	(null,'Criminal Justice'),
	(null,'Hospitality and Culinary Arts'),
	(null,'Design'),
	(null,'Healthcare'),
	(null,'Nursing'),
	(null,'Information Technology'),
	(null,'Energy and Electronics Technology');
...
VALUES
    ...
    (null,'Associate in Science, Nursing', 7),
...
CREATE TABLE student_table (
  ...
  quarter varchar(5),
  description text,
  award enum('Nominee','Award Recipient','Honorable Mention'),
  FOREIGN KEY (prog_id) REFERENCES program_table(prog_id)
) ENGINE=InnoDB, AUTO_INCREMENT=1;

INSERT INTO student_table
	(stud_id, prog_id, stud_name, gender, image, quarter, description, award)
	VALUES 
	(null,15,'Dennis Cupp','Male','default-male.jpg', '4th', 'Im Awesome!','Nominee'),
	(null,6,'Suzzie Que','Female','default-female.jpg', '1st', 'I''m Less Awesome than Dennis!','Nominee'),
    (null,11,'Jimmy James','Male','default-male.jpg','5th','I tried my best!','Honorable Mention');
...
SELECT stud_id, stud.stud_name, stud.gender, stud.image, stud.quarter, prog.prog_name, school.school_name, stud.description, stud.award
...
SELECT stud.stud_id, stud.stud_name, stud.image, school.school_name, p.prog_id, p.prog_name, stud.quarter, stud.award, stud.description 
FROM student_table AS stud 
INNER JOIN program_table AS p ON stud.prog_id = p.prog_id 
INNER JOIN school_table AS school ON p.school_id = school.school_id 
WHERE stud_id = 1;
